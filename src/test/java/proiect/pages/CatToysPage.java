...
public class CatToysPage extends BasePage {

    @FindBy(xpath = "//h1")
    WebElement pageTitleElement;

    @FindBy(xpath = "//a[@href='?add-to-cart=4737']")
    WebElement addToCartElement;

    @FindBy(xpath = "//a[@class='added_to_cart wc-forward']")
    WebElement verifyCartElement;

    @FindBy(xpath = "//label[@for='shipping_method_0_free_shipping4']")
    ...
    WebElement localityFieldElement;
    ...
    public CatToysPage(WebDriver driver) {
    ...
    public void isPageLoaded() {
        Assert.assertEquals(pageTitleElement.getText(), "Jucării & Accesorii", " Title is invalid and actual value is : " + pageTitleElement.getText());
    }
    ...
    public void selectDeliveryMethod(String delivery) {
        ...
        deliveryMethodList.add(freeDelivery);                                       //se adauga elemente in lista
    ...
    public void fillLocality() {
        elementsHelper.fillElement(localityFieldElement,"Halchiu");
    }
